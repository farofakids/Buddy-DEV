...
//        private static Orbwalking.Orbwalker _orbwalker;
        public static Menu _config { get; set; }
        public static Menu TargetSelectorMenu;
        private static AIHeroClient _player;
        private static SpellSlot _igniteSlot;
        private static Item _tiamat, _hydra, _blade, _bilge, _rand, _lotis, _youmuu;
        ...
        private static Menu Combomenu, Harassmenu, itemsmenu, Farmmenu, LastHitmenu, Miscmenu, Drawingsmenu;
  ...
  /*      private static void OnProcessSpell(Obj_AI_Base unit, GameObjectProcessSpellCastEventArgs castedSpell)
        ...
        private static void Game_OnUpdate(EventArgs args)
        {
           /* if (_config.Item("ActiveCombo").GetValue<KeyBind>().Active)
            ...
            if (Getkeybindvalue(Combomenu, "ActiveCombo"))
            {
//            Combo(GetEnemy);
                Combo(target);
            }
        ...
        private static float ComboDamage(Obj_AI_Base enemy)
        {
            ...
            if (Item.HasItem(3077) && Item.CanUseItem(3077))
                damage += _player.GetItemDamage(enemy, ItemId.Tiamat_Melee_Only);
            if (Item.HasItem(3074) && Item.CanUseItem(3074))
                damage += _player.GetItemDamage(enemy, ItemId.Ravenous_Hydra_Melee_Only);
            if (Item.HasItem(3153) && Item.CanUseItem(3153))
                damage += _player.GetItemDamage(enemy, ItemId.Blade_of_the_Ruined_King);
            if (Item.HasItem(3144) && Item.CanUseItem(3144))
                damage += _player.GetItemDamage(enemy, ItemId.Bilgewater_Cutlass);
            if (_q.IsReady())
        ...
        private static void TheLine(AIHeroClient t)
        {
            ...
            if (UltStage == UltCastStage.First)  
                _r.Cast(target);
            linepos = target.Position.Extend(_player.ServerPosition, -500).To3D();
        ...
        private static void CastW(Obj_AI_Base target)
        {
            ...
            //_w.Cast(herew, true);
            _w.Cast(target.Position.Extend(ObjectManager.Player.Position, -200).To3D());
        ...
        private static void CastQ(Obj_AI_Base target)
        {
            ...
            if (WShadow != null && target.Distance(WShadow.ServerPosition) <= 900 && target.Distance(_player.ServerPosition)>450)
            {
                ...
                //_q.UpdateSourcePosition(WShadow.ServerPosition, WShadow.ServerPosition);
                    _q.SourcePosition = WShadow.ServerPosition;
            ...
            else
            {
                ...
                _q.SourcePosition = _player.ServerPosition;
        ...
        private static void KillSteal()
        {
            ...
            var igniteDmg = _player.GetSummonerSpellDamage(target, DamageLibrary.SummonerSpells.Ignite);
           ...
           /* if (target.IsValidTarget() && _q.IsReady() && _config.Item("UseQM").GetValue<bool>() && _q.GetDamage(target) > target.Health)
            {
                ...
                else if (RShadow != null && RShadow.Distance(target.ServerPosition) <= _q.Range)
                {
                    ...
                    _q.SourcePosition = RShadow.ServerPosition;
                    _q.Cast(target);
                }
            }*/
