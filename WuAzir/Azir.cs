...
namespace WuAIO
{
    class Azir : HeroBase
    {
        ...
        readonly Spell.Skillshot Q = new Spell.Skillshot(SpellSlot.Q, 875, SkillShotType.Linear, 250, 1000, 70);
        readonly Spell.Skillshot W = new Spell.Skillshot(SpellSlot.W, 450, SkillShotType.Circular);
        readonly Spell.Skillshot E = new Spell.Skillshot(SpellSlot.E, 1100, SkillShotType.Linear, 250, 1600, 100);
        ...
        {
            var Target = TargetSelector.GetTarget(Q.Range + 200, DamageType.Physical);
