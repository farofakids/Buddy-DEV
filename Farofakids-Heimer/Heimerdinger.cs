            ...
            public static class Modes
            {
                ...
                public static class Harass
                {
                    ...
                    static Harass()
                    {
                        ...
                        _manaHarass = SpellsMenu.Add("harassMana", new Slider("min. mana for harass", 50));
                    }
                ...
                public static class LaneClear
                {
                    ...
                    static LaneClear()
                    {
                        ...
                        _laneMana = FarmMenu.Add("laneMana", new Slider("min. mana for clear", 80));
                        _xCount = FarmMenu.Add("xCount", new Slider("min. minion", 3, 1, 6));
                    }
                ...
                public static class LastHit
                {
                    ...
                    static LastHit()
                    {
                        ...
                        _lastMana = FarmMenu.Add("lastMana", new Slider("min. mana for LastHit", 90));
                    }
